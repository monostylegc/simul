...
from backend.segmentation.training.validate_labels import validate_label_map
from backend.segmentation.training.download import (
    DatasetInfo,
    validate_verse2020,
    validate_ctspine1k,
    validate_spider,
...
from backend.segmentation.training.dataset_crawl import (
    CaseInfo,
    crawl_verse2020,
    crawl_ctspine1k,
    crawl_spider,
...
class TestRunPipeline:
    ...
    def test_skip_existing(self, tmp_path):
        """이미 변환된 케이스 스킵 확인."""
        from backend.segmentation.training.run_pipeline import _case_already_exists
    ...
    def test_build_case_id(self):
        """케이스 ID 포맷."""
        from backend.segmentation.training.run_pipeline import _build_case_id
