...
from backend.api.services.gpu_detect import (
    detect_gpu,
    resolve_device,
    GpuInfo,
...
class TestGpuDetect:
    ...
    def setup_method(self):
        """매 테스트마다 캐시 초기화."""
        import backend.api.services.gpu_detect as mod
    ...
    def test_resolve_device_gpu_no_cuda(self):
        ...
        with patch("backend.api.services.gpu_detect.detect_gpu", return_value=fake_info):
